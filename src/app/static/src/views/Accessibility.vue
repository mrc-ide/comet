<template>
  <div class="accessibility">
    <h1>Accessibility</h1>
    <p>This statement applies to content published on https://comet.dide.ic.ac.uk</p>
    <p>
      We want this website to be as accessible as possible. For example, that means you should
      be able to:
    </p>
    <ul>
    ...
    <p>
      We work to achieve and maintain <a href="https://www.w3.org/TR/WCAG21/">WCAG 2.1 AA standards</a>,
      but it is not always possible for all our
      content to be accessible. Where content is not accessible, we will state a reason, warn user
    ...
    <p>
      This website is partially compliant with the <a href="https://www.w3.org/TR/WCAG21/">Web Content
      Accessibility Guidelines version 2.1</a> AA standard, due to the known issues listed above.
    </p>
    ...
    <p id="access-email">
      ...
      print, easy read, audio recording or braille or if you find any accessibility issues not
      listed on this page then please contact
    ...
    <p>
      This website was last tested for accessibility compliance on 25 November 2021, and these
      tests have been carried out internally using the
      <a href="https://accessibilityinsights.io/en/">Accessibility Insights</a> tools.
    </p>
    <h2>Last updated</h2>
    <p>This statement was prepared on 25 November 2021. It was last updated on 25 November 2021.</p>
  </div>
</template>

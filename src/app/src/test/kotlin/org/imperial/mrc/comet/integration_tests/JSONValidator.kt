...
class JSONValidator {
    ...
    private val cometrVersion = File("../config/cometr_version").readLines().first()
    ...
    {
        val location = "https://raw.githubusercontent.com/mrc-ide/cometr/$cometrVersion/inst/schema/"
